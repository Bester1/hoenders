...
const DEFAULT_PRICING = {
    ...
    'BRAAIPAKKE': { cost: 65.00, selling: 75.00, packaging: '1 heel hoender opgesny VAKUUM VERPAK - ± 2kg+' },
    'HEEL HALWE HOENDERS': { cost: 60.00, selling: 70.00, packaging: 'Heel hoender deurgesny ± 900g - 1.2kg' },
    'BORSSTUKKE MET BEEN EN VEL (2 IN PAK)': { cost: 64.00, selling: 74.00, packaging: '2 in pak ± 300g p 1 stuk' },
    'BORSSTUKKE MET BEEN EN VEL (4 IN PAK)': { cost: 64.00, selling: 74.00, packaging: '4 in pak ± 300g p 1 stuk' },
    'VLERKIES': { cost: 79.00, selling: 95.00, packaging: '8 in pak - ± 700g - 900g VAKUUM VERPAK' },
    'BOUDE EN DYE': { cost: 71.00, selling: 82.00, packaging: '2 boude en 2 dye in pak ± 700g - 900g' },
    'GUNS Boud en dy aanmekaar': { cost: 73.00, selling: 84.00, packaging: '3 in pak - ± 1kg - 1.2kg VAKUUM VERPAK' },
    ...
    'ONTBEENDE HOENDER': { cost: 115.00, selling: 132.00, packaging: 'VAKUUM VERPAK - ± 1kg - 1.2kg' },
...
function showSection(sectionId) {
    ...
    // The customer list is a database read, so load it when the tab is first
    ...
    if (sectionId === 'notices' && typeof initNotices === 'function'
        && !showSection._noticesLoaded) {
        showSection._noticesLoaded = true;
        initNotices();
    }
}
